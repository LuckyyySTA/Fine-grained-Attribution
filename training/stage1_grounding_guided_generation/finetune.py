...
def parse_args():
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Generate a plan before generate the answer."
        ),
    )
...
def encode_with_prompt_completion_format(example, tokenizer, max_seq_length):
    ...
    source_text = prompt_input.format_map(example)
...
def main():
    ...
    if isinstance(tokenizer, LlamaTokenizer) or isinstance(tokenizer, LlamaTokenizerFast):
        ...
        if args.use_special_tokens is True:
            special_token_dict = {"additional_special_tokens": ["[GROUNDING]", "[ANSWER]"]}
        ...
        if args.use_special_tokens is False:
            ...
            # assert num_added_tokens > 6, "special tokens must be added to the original tokenizers."
    ...
    if args.with_tracking:
        ...
        accelerator.init_trackers("stage1", experiment_config)
